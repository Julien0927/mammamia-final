        ...
        <footer class="footer-clean">
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="col-sm-4 col-md-3 item">
                        <h3 class="centerText" style="color: #CDB987">Contact</h3>
                        <ul>
                            <li class="centerText"><img src="assets/icones/phone1.png" loading="lazy" alt="téléphone fixe" class="mx-2">05 46 31 47 70</li>
                            <li class="centerText"><img src="assets/icones/message.png" loading="lazy" alt="Email de contact" class="mx-2">contact@mammamia-lr.com</li>
                            <li class="centerText">Privatisation :  </li>
                            <li class="centerText"><img src="assets/icones/message.png" loading="lazy" alt="Email de contact pour privatisation" class="mx-2">evenements@mammamia-lr.com</li >
                        </ul>
                    </div>
                    <div class="col-sm-4 col-md-3 item">
